        ...
        <div class="row mb-5">
            <div class="col-12">
                <div class="container-fluid">
                    <form id="update_form" action="/settings" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        {{method_field('PATCH')}}
                        ...
                        <div class="row rowOfInputs">
                            <div id="preview" class="col-2">
                                <p class="mt-4"> لوگو :
                                    <img id="avatar" src="{{asset($setting->logo)}}" alt="در حال بارگذاری عکس" class="createPostImage mr-2">
                                </p>
                            </div>
