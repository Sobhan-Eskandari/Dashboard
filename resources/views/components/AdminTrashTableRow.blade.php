...
<td>
    <div class="pure-checkbox mt-2 mr-2">
        <input id="category_checkbox-{{$chk_name}}" class="checkbox-{{$chk_name}}" onclick="selectCmntCheckbox(event)" name="category_checkbox-{{$chk_name}}" type="checkbox" >
        <label for="category_checkbox-{{$chk_name}}"></label>
    </div>
</td>
